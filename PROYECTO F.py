...
print(sys2)
 ...
 # Funcion de transferencia del controlador pg. 85 doc
# numPID = [Rr*Re*Cr*Ce,Re*Ce+Rr*Cr,1]
# denPID = [Re*Cr,0]
# PID = control.tf(numPID,denPID)
# print(PID)
 # Funcion de transferencia del sistema de control
# X = control.series(PID,sys)
# sysPID = control.feedback(X,1,sing = -1) #feedback es retroalimentacion
# print(sysPID)
...
fig4.savefig('python_ProyectoF.png', dpi=600, bbox_inches='tight')
fig4.savefig('python_ProyectoF.pdf')
